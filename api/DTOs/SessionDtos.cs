...
public record CreateSessionRequest(string Date, string StartTime, string Type, string Title, string? Location, List<Guid>? CoachIds, Guid? StudentId);
public record UpdateSessionRequest(string Date, string StartTime, string Type, string Title, string? Location, List<Guid>? CoachIds, Guid? StudentId);
public record BulkCreateSessionsRequest(List<string> Dates, string StartTime, string Type, string Title, string? Location, List<Guid>? CoachIds, Guid? StudentId);
